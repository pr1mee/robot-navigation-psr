...
static const _PositionLabelledArray_type_support_symbol_names_t _PositionLabelledArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robile_interfaces, msg, PositionLabelledArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robile_interfaces, msg, PositionLabelledArray)),
  }
};
...
{
  return &::robile_interfaces::msg::rosidl_typesupport_cpp::PositionLabelledArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robile_interfaces, msg, PositionLabelledArray)() {
  return get_message_type_support_handle<robile_interfaces::msg::PositionLabelledArray>();
}
